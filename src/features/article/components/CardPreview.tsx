...
export const CardPreview = () => {
	return (
		<article className="w-[20rem] h-max bg-white pb-5 overflow-hidden rounded-xl md:flex md:w-full md:h-max lg:w-[45rem] md:pb-0 shadow-2xl">
			<img
				src="./image.png"
				alt="Imagen de redes sociales"
				className="aspect-square object-cover object-center h-60 md:h-max md:w-[18rem] w-full"
			/>
			<div className="flex flex-col justify-center gap-10 px-8 py-2 mt-4 md:mt-0">
